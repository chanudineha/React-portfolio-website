...
const Header = () => {
  ...
  return (
    ...
    <div className="absolute w-full  z-50 tansition-all duration-300">
      ...
      {contactFormOpen &&(
        ...
        >
         ...
         <form className="space-y-4">
            ...
            border-gray-600 rounded-lg foucs:ring-2
            foucs:ring-violet-500
            foucs:border-violet-500 bg-gray-700"
            />
          </div>
